...
def basicPageSetup(pageNo):
    ...
    back_img = tk.PhotoImage(file= r"D:\projects\CriminalIdentificationSystem-master\Widgets\back.png")
...
def showCriminalProfile(name):
    ...
    (id, criminaldata1) = retrieveData(name)
    ...
    for i, item in enumerate(criminaldata1.items()):
...
logo = tk.PhotoImage(file = r"D:\projects\CriminalIdentificationSystem-master\Widgets\logo2.png")
